...
- **SDK路径**: `/Users/fanshengxia/Desktop/ichoice_data/ichoice/EMQuantAPI_Python/python3/`
- **账号信息**: `/Users/fanshengxia/Desktop/ichoice_data/ichoice/account.json`
- **指标映射表**: `/Users/fanshengxia/Desktop/ichoice_data/ichoice/数据指标.xlsx`

> **注意**: 已修复路径问题，创建了符号链接 `~/Desktop/ichoice -> ~/Desktop/ichoice_data/ichoice`
...
```python
import sys
sys.path.insert(0, '/Users/fanshengxia/Desktop/ichoice_data/ichoice/EMQuantAPI_Python/python3')
...
### 路径错误
如果提示找不到 `libEMQuantAPIx64.dylib`，检查是否已创建符号链接：
```bash
ls -la ~/Desktop/ichoice
# 应该显示: ~/Desktop/ichoice -> ~/Desktop/ichoice_data/ichoice
```

如果没有，执行：
```bash
ln -sf ~/Desktop/ichoice_data/ichoice ~/Desktop/ichoice
```
